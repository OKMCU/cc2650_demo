...
.dlls,rm3 .dlls: project.prm3

-include package/cfg/project_prm3.mak
-include package/cfg/project_prm3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/project_prm3.dep
endif
project.prm3: package/cfg/project_prm3.xdl
	@


ifeq (,$(wildcard .libraries,rm3))
project.prm3 package/cfg/project_prm3.c: .libraries,rm3
endif

package/cfg/project_prm3.c package/cfg/project_prm3.h package/cfg/project_prm3.xdl: override _PROG_NAME := project.xrm3
package/cfg/project_prm3.c: package/cfg/project_prm3.cfg
package/cfg/project_prm3.xdc.inc: package/cfg/project_prm3.xdl
package/cfg/project_prm3.xdl package/cfg/project_prm3.c: .interfaces

clean:: clean,rm3
	-$(RM) package/cfg/project_prm3.cfg
	-$(RM) package/cfg/project_prm3.dep
	-$(RM) package/cfg/project_prm3.c
	-$(RM) package/cfg/project_prm3.xdc.inc

clean,rm3::
	-$(RM) project.prm3
.executables,rm3 .executables: project.xrm3

project.xrm3: |project.prm3

-include package/cfg/project.xrm3.mak
project.xrm3: package/cfg/project_prm3.orm3 
	$(RM) $@
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o D:/Workspace/Projects/cc2650_demo/rfPacketTx/Debug/Exe/project.out --map D:/Workspace/Projects/cc2650_demo/rfPacketTx/Debug/List/project.map --config D:/Workspace/Projects/cc2650_demo/rfPacketTx/project_CC2650_LAUNCHXL.icf -f D:/Workspace/Projects/cc2650_demo/rfPacketTx/configPkg/linker.cmd c:/ti/tirtos_cc13xx_cc26xx_2_21_01_08/products/cc26xxware_2_24_03_17272/driverlib/bin/iar/driverlib.lib --silent --cpu=Cortex-M3 --entry=__iar_program_start --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall --semihosting --entry __iar_program_start --vfe --silent -o $@ package/cfg/project_prm3.orm3 -f package/cfg/project_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

project.test test,rm3 test: project.xrm3.test

project.xrm3.test:: project.xrm3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 project.xrm3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.project.xrm3, ) 
endif

clean,rm3::
	-$(RM) $(wildcard .tmp,project.xrm3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
project_prm3.orm3,copy : package/cfg/project_prm3.orm3
project_prm3.srm3,copy : package/cfg/project_prm3.srm3
